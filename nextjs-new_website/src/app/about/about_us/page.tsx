...
async function getCurrentPartners() {
    const query = `*[_type == "partnerCurrent"]{ 
    _id, 
    name, 
    logo, 
    hyperlink 
            ...
            <main className='flex-grow'>
                ...
                <div className='border-b py-16 px-4 mb-12'>
                    ...
                    <p className='text-lg text-center mt-4 max-w-3xl mx-auto'>
                        {" "}
                        Learn more about our mission, programs, partnerships,
                ...
                <div className='w-full max-w-7xl mx-auto py-12 px-4'>
                    <div className='max-w-4xl mx-auto space-y-10'>
                        {abouts.map((about) => (
                            <div
                                key={about._id}
                                className='bg-background rounded-2xl shadow-sm p-8 border'
                            >
                    ...
                    <div className='max-w-6xl mx-auto'>
                        ...
                        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6'>
                            {pPartners.map((partner) => (
                                <div
                                    key={partner._id}
                                    className='bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center justify-center h-40'
                                >
                                    <Image
