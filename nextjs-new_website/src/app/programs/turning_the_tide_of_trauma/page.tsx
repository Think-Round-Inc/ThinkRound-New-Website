...
const portableTextComponents: PortableTextComponents = {
    block: {
        ...
        h2: ({ children }) => (
            <h2 className='mb-4 mt-8 text-3xl font-semibold md:text-4xl'>
                {children}
            </h2>
        ),
        h3: ({ children }) => (
            <h3 className='mb-4 mt-8 text-2xl font-semibold md:text-3xl'>
                {children}
            </h3>
        ),
        normal: ({ children }) => (
            <p className='mb-5 text-2xl text-center leading-8 text-foreground'>
                {children}
            </p>
        ),
        blockquote: ({ children }) => (
            <blockquote className='my-8 border-l-1 border-[#4b556392] pl-5 text-2xl text-foreground'>
                {children}
            </blockquote>
        ),
    },
    ...
    list: {
        ...
        number: ({ children }) => (
            <ol className='mb-6 list-decimal space-y-2 pl-6 text-lg '>
                {children}
            </ol>
        ),
    },
...
const leftAlignedComponents: PortableTextComponents = {
    ...
    block: {
        normal: ({ children }) => (
            <p className='mb-5 text-2xl text-left leading-8 text-foreground'>
                {children}
            </p>
        ),
    },
    ...
    if (!ttot) {
        return (
            <div className='flex min-h-screen items-center justify-center px-6 text-center'>
                <p className='text-xl'>Content not available yet.</p>
            </div>
        );
    }
        ...
        <div className='min-h-screen'>
            ...
            <main className=' flex flex-col w-full max-w-4xl  mx-auto px-6 py-16 sm:px-8 lg:px-12'>
                ...
                <section>
                    ...
                    <div className='mb-5 text-2xl text-center leading-8 text-dark'>
                        {ttot.paragraph1 && (
