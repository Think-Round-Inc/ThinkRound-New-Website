      ...
      <main className="keep-page">
        ...
        {data.image1 && (
          <section className="keep-wide-section">
            ...
            {data.caption1 && (
              <p className="keep-caption keep-wide-caption">{data.caption1}</p>
            )}
          </section>
        )}
        ...
        {data.image2 && (
          <section className="keep-small-section">
            ...
            {data.caption2 && <p className="keep-caption">{data.caption2}</p>}
          </section>
        )}
        ...
        {data.image3 && (
          <section className="keep-medium-section">
            ...
            {data.caption3 && <p className="keep-caption">{data.caption3}</p>}
          </section>
        )}
