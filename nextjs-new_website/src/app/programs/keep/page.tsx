        ...
        return (
            <div className=' min-h-screen'>
                <main className='keep-empty'>
                    ...
                    <p>
                        Please create and publish the KEEP document in Sanity
                        Studio.
                    </p>
                </main>
            </div>
                ...
                {data.image1 && (
                    <section className='keep-wide-section'>
                        <Image
                            ...
                            alt={
                                data.caption1 ||
                                "KEEP environmental education program"
                            }
                            width={1500}
                            height={900}
                ...
                {data.image3 && (
                    <section className='keep-medium-section'>
                        <Image
                            ...
                            alt={
                                data.caption3 || "KEEP students on a field trip"
                            }
                            width={1100}
                            height={760}
