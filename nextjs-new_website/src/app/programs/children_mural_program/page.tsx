...
const portableTextComponents: PortableTextComponents = {
    block: {
        ...
        h1: ({ children }) => (
            <h1 className='my-6 text-5xl font-bold leading-tight'>
                {children}
            </h1>
        ),
        ...
        h3: ({ children }) => (
            <h3 className='my-4 text-3xl font-bold leading-tight'>
                {children}
            </h3>
        ),

        h4: ({ children }) => (
            <h4 className='my-3 text-2xl font-bold leading-tight'>
                {children}
            </h4>
        ),

        large: ({ children }) => (
            <p className='mb-5 text-xl leading-9 sm:text-2xl'>{children}</p>
        ),

        small: ({ children }) => (
            <p className='mb-4 text-sm leading-6 sm:text-base'>{children}</p>
        ),

        center: ({ children }) => (
            <p className='mb-5 text-center leading-8'>{children}</p>
        ),
        ...
        normal: ({ children }) => (
            <p className='mb-5 leading-8 last:mb-0'>{children}</p>
        ),
    ...
    list: {
        bullet: ({ children }) => (
            <ul className='mb-5 list-disc space-y-2 pl-7'>{children}</ul>
        ),

        number: ({ children }) => (
            <ol className='mb-5 list-decimal space-y-2 pl-7'>{children}</ol>
        ),
    },
    ...
    marks: {
        ...
        fontFamily: ({ children, value }) => {
            const family = fontFamilies[value?.family] || value?.family;
    ...
    return (
        ...
        '
            ...
            '
                ...
                overflow-hidden
                bg-white
                ${centerThumbnails ? "" : "min-h-[400px] sm:min-h-[500px]"}
              `}
                        >
                            <Image
                                src={urlFor(image).width(1800).url()}
      ...
      `}
        ...
        '
          ...
          '
                ...
                {(data.bookletIntroduction?.length || data.bookletUrl) && (
                    <Section
                        className='
              flex
              flex-col
            ...
            '
              ...
              '
                        ...
                        <RichTextContent
                            value={data.historySection.videoDescription}
                        ...
                        <RichTextContent
                            value={data.historySection.galleryIntroduction}
                            className='my-10 text-lg sm:text-xl'
                        />
              ...
              '
                        ...
                        <RichTextContent
                            value={data.essayAnthologies.image?.caption}
                            className='
                mb-12
                text-sm
                font-semibold
              ...
              '
                        ...
                        <RichTextContent
                            value={data.essayAnthologies.galleryHeading}
                            className='
              ...
              '
                        ...
                        <ImageGallery
                            images={data.essayAnthologies.awardsGallery}
